      ...
      if (chat.welcome) {
        ...
        for (let user of participants) {
          ...
          try {
            ...
            console.error(`Error retrieving profile picture: ${error}`)
            pp = 'https://i.ibb.co/gTPG9WF/dca092a4ec1e6208f8dd16a413ef3dda.jpg' // Assign default image URL
            ppgp = 'https://i.ibb.co/gTPG9WF/dca092a4ec1e6208f8dd16a413ef3dda.jpg' // Assign default image URL
          } finally {
