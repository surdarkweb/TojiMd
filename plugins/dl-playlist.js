...
let handler = async (m, { conn, text, usedPrefix, command }) => {
  ...
  await m.reply("🔄 🎧 Hang tight! Toji MD is fetching your playlist from Spotify! 🤩...");
  ...
  try {
    ...
    let playlistMessage = `_🎶 TOJI SPOTIFY PLAYLIST 🎶_\n\n`;
      ...
      m.chat,
      {
        ...
        contextInfo: {
          ...
          externalAdReply: {
            ...
            title: "TOJI Spotify Playlist",
            body: "TOJI SPOTIFY SEARCH",
    ...
    m.reply(`❌ TOJI MD encountered an error: ${error.message}`);
    console.error(error);
  }
};
